                        ...
                        {model.elements.map((element, index) => {
                            ...
                            return (
                                <mesh
                                    ...
                                    onDoubleClick={(e) => {
                                        e.stopPropagation(); // Stop bubbling (OrbitControls won't see it?)
                                        // e.point is the point of intersection in World Space
                                        console.log("📍 PINCH POINT:", e.point);
                                        useStore.getState().setPendingPin(e.point);
                                        // Also select the element to make it clear what we are pinning on
                                        selectElement(element, model.id);
                                    }}
                                >
